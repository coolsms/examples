...
function createImage () {
  ...
  // image API 에서 이미지 생성
  $url = "https://api.coolsms.co.kr/images/v4/images";
  $fields = new stdClass();
...
function add_message($groupId) {
  ...
  $url = "https://api.coolsms.co.kr/messages/v4/groups/{$groupId}/messages";
...
function send_message($groupId) {
  $url = "https://api.coolsms.co.kr/messages/v4/groups/{$groupId}/send";
  $result = request("POST", $url);
